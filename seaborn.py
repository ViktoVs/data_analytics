...
# boxplot
def sns_boxplot(df, x, y, hue=None, figsize=(6, 5), y_limit=None):
...
#barplot
def sns_barplot(df, x, y, hue=None, figsize=(6, 5), fmt="d"):
...
#heatmap
def sns_heatmap(df, hue=None, figsize=(6, 5), fmt="d"):
    fig, ax = plt.subplots(figsize)
